...
pub trait UserApi {
    fn get_user(&self, ) -> Box<dyn Future<Item = ::models::UserResponse, Error = Error<serde_json::Value>>>;
}
...
impl<C: hyper::client::Connect>UserApi for UserApiClient<C> {
    fn get_user(&self, ) -> Box<dyn Future<Item = ::models::UserResponse, Error = Error<serde_json::Value>>> {
        ...
        configuration.client.request(req)
            ...
            .and_then(|body| {
                let parsed: Result<::models::UserResponse, _> = serde_json::from_slice(&body);
