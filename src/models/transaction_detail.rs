...
impl TransactionDetail {
  ...
  pub fn with_date(mut self, date: String) -> TransactionDetail {
    self.date = date;
    self
  }
  ...
  pub fn with_amount(mut self, amount: i64) -> TransactionDetail {
    self.amount = amount;
    self
  }
  ...
  pub fn with_memo(mut self, memo: String) -> TransactionDetail {
    self.memo = Some(memo);
    self
  }
  ...
  pub fn with_cleared(mut self, cleared: String) -> TransactionDetail {
    self.cleared = cleared;
    self
  }
  ...
  pub fn with_flag_color(mut self, flag_color: String) -> TransactionDetail {
    self.flag_color = Some(flag_color);
    self
  }
  ...
  pub fn with_payee_id(mut self, payee_id: String) -> TransactionDetail {
    self.payee_id = Some(payee_id);
    self
  }
  ...
  pub fn with_category_id(mut self, category_id: String) -> TransactionDetail {
    self.category_id = Some(category_id);
    self
  }
  ...
  pub fn with_transfer_account_id(mut self, transfer_account_id: String) -> TransactionDetail {
    self.transfer_account_id = Some(transfer_account_id);
    self
  }
  ...
  pub fn with_transfer_transaction_id(mut self, transfer_transaction_id: String) -> TransactionDetail {
    self.transfer_transaction_id = Some(transfer_transaction_id);
    self
  }
  ...
  pub fn with_matched_transaction_id(mut self, matched_transaction_id: String) -> TransactionDetail {
    self.matched_transaction_id = Some(matched_transaction_id);
    self
  }
  ...
  pub fn with_import_id(mut self, import_id: String) -> TransactionDetail {
    self.import_id = Some(import_id);
    self
  }
  ...
  pub fn with_import_payee_name(mut self, import_payee_name: String) -> TransactionDetail {
    self.import_payee_name = Some(import_payee_name);
    self
  }
  ...
  pub fn with_import_payee_name_original(mut self, import_payee_name_original: String) -> TransactionDetail {
    self.import_payee_name_original = Some(import_payee_name_original);
    self
  }
  ...
  pub fn with_payee_name(mut self, payee_name: String) -> TransactionDetail {
    self.payee_name = Some(payee_name);
    self
  }
  ...
  pub fn with_category_name(mut self, category_name: String) -> TransactionDetail {
    self.category_name = Some(category_name);
    self
  }
