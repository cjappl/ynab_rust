...
impl TransactionsResponseData {
  ...
  pub fn with_transactions(mut self, transactions: Vec<::models::TransactionDetail>) -> TransactionsResponseData {
    self.transactions = transactions;
    self
  }
  ...
  pub fn with_server_knowledge(mut self, server_knowledge: i64) -> TransactionsResponseData {
    self.server_knowledge = server_knowledge;
    self
  }
