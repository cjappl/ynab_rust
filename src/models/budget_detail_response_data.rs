...
impl BudgetDetailResponseData {
  ...
  pub fn with_budget(mut self, budget: ::models::BudgetDetail) -> BudgetDetailResponseData {
    self.budget = budget;
    self
  }
  ...
  pub fn with_server_knowledge(mut self, server_knowledge: i64) -> BudgetDetailResponseData {
    self.server_knowledge = server_knowledge;
    self
  }
