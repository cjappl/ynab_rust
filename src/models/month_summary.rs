...
impl MonthSummary {
  ...
  pub fn with_month(mut self, month: String) -> MonthSummary {
    self.month = month;
    self
  }
  ...
  pub fn with_note(mut self, note: String) -> MonthSummary {
    self.note = Some(note);
    self
  }
  ...
  pub fn with_income(mut self, income: i64) -> MonthSummary {
    self.income = income;
    self
  }
  ...
  pub fn with_budgeted(mut self, budgeted: i64) -> MonthSummary {
    self.budgeted = budgeted;
    self
  }
  ...
  pub fn with_activity(mut self, activity: i64) -> MonthSummary {
    self.activity = activity;
    self
  }
  ...
  pub fn with_to_be_budgeted(mut self, to_be_budgeted: i64) -> MonthSummary {
    self.to_be_budgeted = to_be_budgeted;
    self
  }
  ...
  pub fn with_age_of_money(mut self, age_of_money: i32) -> MonthSummary {
    self.age_of_money = Some(age_of_money);
    self
  }
  ...
  pub fn with_deleted(mut self, deleted: bool) -> MonthSummary {
    self.deleted = deleted;
    self
  }
