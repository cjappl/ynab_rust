...
impl SaveTransaction {
  ...
  pub fn with_date(mut self, date: String) -> SaveTransaction {
    self.date = date;
    self
  }
  ...
  pub fn with_amount(mut self, amount: i64) -> SaveTransaction {
    self.amount = amount;
    self
  }
  ...
  pub fn with_cleared(mut self, cleared: String) -> SaveTransaction {
    self.cleared = Some(cleared);
    self
  }
  ...
  pub fn with_flag_color(mut self, flag_color: String) -> SaveTransaction {
    self.flag_color = Some(flag_color);
    self
  }
  ...
  pub fn with_subtransactions(mut self, subtransactions: Vec<::models::SaveSubTransaction>) -> SaveTransaction {
    self.subtransactions = Some(subtransactions);
    self
  }
