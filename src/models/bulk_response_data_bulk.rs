...
impl BulkResponseDataBulk {
  ...
  pub fn with_transaction_ids(mut self, transaction_ids: Vec<String>) -> BulkResponseDataBulk {
    self.transaction_ids = transaction_ids;
    self
  }
  ...
  pub fn with_duplicate_import_ids(mut self, duplicate_import_ids: Vec<String>) -> BulkResponseDataBulk {
    self.duplicate_import_ids = duplicate_import_ids;
    self
  }
